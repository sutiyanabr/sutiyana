...
<div class="card mt-3">
    ...
    <div class="card-body">
        <form class="form-control mt-3" action="prosesinputmasuk.php" method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="asal_surat" required>
                ...
                <input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="tanggal_terima"required>
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="penerima"required>
            </div>
            <div class="text-end">
